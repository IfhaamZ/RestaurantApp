...
// when(dbManager.reserveTable(1, reservationTime, "John Doe", "123456789",
// "john@example.com"))
// .thenReturn(true);

// // Act
// boolean result = dbManager.reserveTable(1, reservationTime, "John Doe",
// "123456789", "john@example.com");

// // Assert
// assertTrue(result);
// verify(dbManager, times(1))
// .reserveTable(1, reservationTime, "John Doe", "123456789",
// "john@example.com");
// }
