...
public class ReservationDAOTest {
    ...
    public void testInsertReservation() throws SQLException {
        Reservation reservation = new Reservation(0, "John Doe", LocalDate.now(), LocalTime.of(18, 30), 4);
    ...
    public void testFetchAllReservations() throws SQLException {
        ...
        reservationList.add(new Reservation(0, "John Doe", LocalDate.now(), LocalTime.of(18, 30), 4));
        reservationList.add(new Reservation(1, "Jane Doe", LocalDate.now().plusDays(1), LocalTime.of(19, 0), 2));
    ...
    public void testUpdateReservation() throws SQLException {
        Reservation updatedReservation = new Reservation(1, "Updated Name", LocalDate.now().plusDays(2), LocalTime.of(20, 0), 5);
        ...
        Assertions.assertTrue(result);
        Mockito.verify(reservationDAO, Mockito.times(1)).updateReservation(updatedReservation);
    }
    ...
    public void testDeleteReservation() throws SQLException {
        ...
        Mockito.doNothing().when(reservationDAO).deleteReservation(reservationId, reservationName);
        reservationDAO.deleteReservation(reservationId, reservationName);
        Mockito.verify(reservationDAO, Mockito.times(1)).deleteReservation(reservationId, reservationName);
    }
}
