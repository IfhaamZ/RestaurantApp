...
public class EventDBManagerTest {
    ...
    public void testFetchAllEvents() throws Exception {
        ...
        eventList.add(new Event(0, "Music Night", "Enjoy live music", LocalDate.now(), "Music"));
        eventList.add(new Event(0, "Art Exhibition", "View various art pieces", LocalDate.now().plusDays(2), "Art"));
    ...
    public void testUpdateEvent() throws Exception {
        // Arrange
        Event updatedEvent = new Event(1, "Updated Music Night", "Updated Description", LocalDate.now().plusDays(1),
                "Music");
